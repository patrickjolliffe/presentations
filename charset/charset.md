...
[.code-highlight: all]
```
➜ encode.py ascii -d Hund,dog,pies
...
[.code-highlight: all]
```
➜ encode.py latin2,cp1250 -d köpek,câine
✅ latin2:  Good köpek [6b f6 70 65 6b] (5 bytes)
✅ cp1250:  Good köpek [6b f6 70 65 6b] (5 bytes)
✅ latin2:  Good câine [63 e2 69 6e 65] (5 bytes)
✅ cp1250:  Good câine [63 e2 69 6e 65] (5 bytes)
...
| `iso-8859-13`    | `latin7`    | Windows-1257 (approx.) |
| `iso-8859-15`    | `latin9`    | Windows-1252 (approx.) |
